...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_view_view__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_login_login__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_auth_auth__ = __webpack_require__(7);
...
var SearchPage = /** @class */ (function () {
    ...
    SearchPage.prototype.search = function (text, page) {
        var _this = this;
        ...
        this.error = "",
            this.text = text;
        //alert(page);
        this.awri.search(this.text, page).then(function (data) {
            _this.page = page;
            _this.items = data;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_auth_auth__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_view_view__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__searchcat_searchcat__ = __webpack_require__(114);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BereichPage = /** @class */ (function () {
    ...
    BereichPage.prototype.dosearch = function () {
        //  alert(this.text2);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_5__searchcat_searchcat__["a" /* SearchcatPage */], { item: { bereich: this.bereich, keys: this.text2 } });
        /*
        this.nodes=[];
    ...
    BereichPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
<<<<<<< HEAD
            selector: 'page-bereich',template:/*ion-inline-start:"/home/robert/Projekte/RechZapp2/src/pages/bereich/bereich.html"*/'<!--\n  Generated template for the BereichPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title><ion-icon name="{{bereich?.icon}}"></ion-icon> {{this.bereich?.name}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n\n  <ion-toolbar>\n        <ion-item>\n                <ion-label> <ion-icon name="search"></ion-icon></ion-label>\n              <ion-input  placeholder="Rechtsfrage suchen..." clearInput\n              [(ngModel)]="text2">\n            </ion-input>\n            <button ion-button item-end (click)="this.dosearch()" small><ion-icon name="search"></ion-icon></button>\n        </ion-item>\n        </ion-toolbar>\n\n\n        <ion-grid *ngIf="this.nodes?.length>0"> \n            <ion-row>\n              <ion-col>\n                <div>\n                 <button *ngIf="this.page>0" ion-button secondary (click)=this.prev() float-left outline><ion-icon name="arrow-round-back"></ion-icon></button>\n                </div>\n              </ion-col>\n              <ion-col text-center>\n                  <ion-toolbar>\n                      <ion-title>\n                       Seite {{this.page+1}}/{{this.bereich?.count/10  | number: \'1.0-0\'}}\n                      </ion-title>\n                    </ion-toolbar>\n                </ion-col>\n              <ion-col>\n                <div>\n                 <button *ngIf="this.nodes?.length==10" ion-button secondary (click)=this.next() float-right outline><ion-icon name="arrow-round-forward"></ion-icon></button>\n                </div>\n              </ion-col>\n            </ion-row>\n          </ion-grid>\n<!--\n    <ion-navbar>\n        <ion-buttons left>\n          <button *ngIf="page>0"  ion-button (click)="prev()">\n            <ion-icon name="arrow-back"></ion-icon>\n          </button>\n        </ion-buttons>\n        <ion-title text-center>{{1+page}}/{{this.bereich?.count/10  | number: \'1.0-0\'}}</ion-title>\n        <ion-buttons right>\n            <button *ngIf="nodes?.length==10" ion-button  (click)="next()"><ion-icon name="arrow-forward"></ion-icon></button>\n          </ion-buttons>\n      </ion-navbar>\n-->\n\n      <banners></banners>\n<div *ngFor="let node of nodes">\n  <ion-card *ngIf="this.text==undefined">\n    <ion-item><p>{{node.created*1000 | date: \'dd.MM.yyyy H:mm\' }}</p></ion-item>\n  <ion-item text-wrap (click)="gotoDetails(node)">\n    <h1>{{node.title}}</h1>\n  </ion-item>\n</ion-card>\n\n<ion-card *ngIf="this.text&&this.text.length>2">\n    <ion-item><p>{{node.created}}</p></ion-item>\n  <ion-item text-wrap (click)="gotoDetails(node)">\n    <h1>{{node.snippet}}</h1>\n  </ion-item>\n</ion-card>\n\n</div>\n<!--\n<button *ngIf="page>0" ion-button small (click)="prev()">Zurück</button></ion-buttons> {{1+page}} <button *ngIf="nodes?.length==10" ion-button small (click)="next()">Weiter</button>\n-->\n<ion-grid *ngIf="this.nodes?.length>0"> \n    <ion-row>\n      <ion-col>\n        <div>\n         <button *ngIf="this.page>0" ion-button secondary (click)=this.prev() float-left outline><ion-icon name="arrow-round-back"></ion-icon></button>\n        </div>\n      </ion-col>\n      <ion-col text-center>\n          <ion-toolbar>\n              <ion-title>\n               Seite {{this.page+1}}/{{this.bereich?.count/10  | number: \'1.0-0\'}}\n              </ion-title>\n            </ion-toolbar>\n        </ion-col>\n      <ion-col>\n        <div>\n         <button *ngIf="this.nodes?.length==10" ion-button secondary (click)=this.next() float-right outline><ion-icon name="arrow-round-forward"></ion-icon></button>\n        </div>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n<!--\n<ion-navbar>\n    <ion-buttons left>\n      <button *ngIf="page>0"  ion-button (click)="prev()">\n        <ion-icon name="arrow-back"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title text-center>{{1+page}}/{{this.bereich?.count/10  | number: \'1.0-0\'}}</ion-title>\n    <ion-buttons right>\n        <button *ngIf="nodes?.length==10" ion-button  (click)="next()"><ion-icon name="arrow-forward"></ion-icon></button>\n      </ion-buttons>\n  </ion-navbar>\n-->\n</ion-content>\n'/*ion-inline-end:"/home/robert/Projekte/RechZapp2/src/pages/bereich/bereich.html"*/,
=======
            selector: 'page-bereich',template:/*ion-inline-start:"/mnt/PLATTE1/bionic/RechZapp2/src/pages/bereich/bereich.html"*/'<!--\n  Generated template for the BereichPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title><ion-icon name="{{bereich?.icon}}"></ion-icon> {{this.bereich?.name}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n\n  <ion-toolbar>\n        <ion-item>\n                <ion-label> <ion-icon name="search"></ion-icon></ion-label>\n              <ion-input  placeholder="Rechtsfrage suchen..." clearInput\n              [(ngModel)]="text2">\n            </ion-input>\n            <button ion-button item-end (click)="this.dosearch()" small><ion-icon name="search"></ion-icon></button>\n        </ion-item>\n        </ion-toolbar>\n\n\n        <ion-grid *ngIf="this.nodes?.length>0"> \n            <ion-row>\n              <ion-col>\n                <div>\n                 <button *ngIf="this.page>0" ion-button secondary (click)=this.prev() float-left outline><ion-icon name="arrow-round-back"></ion-icon></button>\n                </div>\n              </ion-col>\n              <ion-col text-center>\n                  <ion-toolbar>\n                      <ion-title>\n                       Seite {{this.page+1}}/{{this.bereich?.count/10  | number: \'1.0-0\'}}\n                      </ion-title>\n                    </ion-toolbar>\n                </ion-col>\n              <ion-col>\n                <div>\n                 <button *ngIf="this.nodes?.length==10" ion-button secondary (click)=this.next() float-right outline><ion-icon name="arrow-round-forward"></ion-icon></button>\n                </div>\n              </ion-col>\n            </ion-row>\n          </ion-grid>\n<!--\n    <ion-navbar>\n        <ion-buttons left>\n          <button *ngIf="page>0"  ion-button (click)="prev()">\n            <ion-icon name="arrow-back"></ion-icon>\n          </button>\n        </ion-buttons>\n        <ion-title text-center>{{1+page}}/{{this.bereich?.count/10  | number: \'1.0-0\'}}</ion-title>\n        <ion-buttons right>\n            <button *ngIf="nodes?.length==10" ion-button  (click)="next()"><ion-icon name="arrow-forward"></ion-icon></button>\n          </ion-buttons>\n      </ion-navbar>\n-->\n\n      <banners></banners>\n<div *ngFor="let node of nodes">\n  <ion-card *ngIf="this.text==undefined">\n    <ion-item><p>{{node.created*1000 | date: \'dd.MM.yyyy H:mm\' }}</p></ion-item>\n  <ion-item text-wrap (click)="gotoDetails(node)">\n    <h1>{{node.title}}</h1>\n  </ion-item>\n</ion-card>\n\n<ion-card *ngIf="this.text&&this.text.length>2">\n    <ion-item><p>{{node.created}}</p></ion-item>\n  <ion-item text-wrap (click)="gotoDetails(node)">\n    <h1>{{node.snippet}}</h1>\n  </ion-item>\n</ion-card>\n\n</div>\n<!--\n<button *ngIf="page>0" ion-button small (click)="prev()">Zurück</button></ion-buttons> {{1+page}} <button *ngIf="nodes?.length==10" ion-button small (click)="next()">Weiter</button>\n-->\n<ion-grid *ngIf="this.nodes?.length>0"> \n    <ion-row>\n      <ion-col>\n        <div>\n         <button *ngIf="this.page>0" ion-button secondary (click)=this.prev() float-left outline><ion-icon name="arrow-round-back"></ion-icon></button>\n        </div>\n      </ion-col>\n      <ion-col text-center>\n          <ion-toolbar>\n              <ion-title>\n               Seite {{this.page+1}}/{{this.bereich?.count/10  | number: \'1.0-0\'}}\n              </ion-title>\n            </ion-toolbar>\n        </ion-col>\n      <ion-col>\n        <div>\n         <button *ngIf="this.nodes?.length==10" ion-button secondary (click)=this.next() float-right outline><ion-icon name="arrow-round-forward"></ion-icon></button>\n        </div>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n<!--\n<ion-navbar>\n    <ion-buttons left>\n      <button *ngIf="page>0"  ion-button (click)="prev()">\n        <ion-icon name="arrow-back"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title text-center>{{1+page}}/{{this.bereich?.count/10  | number: \'1.0-0\'}}</ion-title>\n    <ion-buttons right>\n        <button *ngIf="nodes?.length==10" ion-button  (click)="next()"><ion-icon name="arrow-forward"></ion-icon></button>\n      </ion-buttons>\n  </ion-navbar>\n-->\n</ion-content>\n'/*ion-inline-end:"/mnt/PLATTE1/bionic/RechZapp2/src/pages/bereich/bereich.html"*/,
>>>>>>> 7fcd870f640e073fe0c2944911b9e17daed1289f
        }),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SearchcatPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_auth_auth__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_view_view__ = __webpack_require__(24);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * Ionic pages and navigation.
 */
var SearchcatPage = /** @class */ (function () {
    function SearchcatPage(navCtrl, navParams, auth, alertCtrl, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.auth = auth;
        this.alertCtrl = alertCtrl;
    ...
    SearchcatPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad SearchcatPage');
    };
    SearchcatPage.prototype.search = function (page) {
        var _this = this;
        this.presentLoading("Suche in '" + this.bereich.name + "' nach '" + this.text + "', Bitte warten...");
        this.auth.searchCat(this.text, this.bereich.tid, page).then(function (data) {
            _this.page = page;
            //  console.log(data);
    ...
    SearchcatPage.prototype.dosearch = function () {
        this.search(0);
    };
    SearchcatPage.prototype.itemSelected = function (item) {
        var _this = this;
        console.log(item);
        this.auth.loadNode(item.node.nid).then(function (data) {
            _this.node = data;
            console.log(_this.node);
            _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__pages_view_view__["a" /* ViewPage */], {
                item: { node: _this.node }
            });
            // console.log(data);
        });
    };
    SearchcatPage.prototype.presentLoading = function (txt) {
        this.loader = this.loadingCtrl.create({
            content: txt,
            duration: 3000
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_auth_auth__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_login_login__ = __webpack_require__(21);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var map = {
	...
	"../pages/searchcat/searchcat.module": [
		307,
		2
	],
...
var LoginPage = /** @class */ (function () {
    function LoginPage(navCtrl, navParams, awri) {
        ...
        this.awri.get('banners').then(function (data) {
            _this.banners = data;
        });
    }
    ...
    LoginPage.prototype.bannersChanged = function (evt) {
        var _this = this;
        this.awri.set('banners', evt.banners).then(function (h) {
            _this.banners = h;
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_auth_auth__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_view_view__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_auth_auth__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__view_view__ = __webpack_require__(24);
    ...
    FragenPage.prototype.getFragen = function () {
        ...
        this.getFragenIndex(this.page, this.pages).then(function (dat) {
            ...
            for (var i = 0; i < d.length; i++) {
                //      console.log(d[i]);
                _this.getFrage(d[i].nid).then(function (dat) {
                    var n = dat;
                    //console.log(n);
                    _this.nodes.push(JSON.parse(n));
                });
            }
            _this.page++;
        });
...
var SettingsPage = /** @class */ (function () {
  ...
  ionViewDidLoad() {
    ...
    */
    ...
    SettingsPage.prototype.bannersChanged = function (evt) {
        var _this = this;
        console.log(evt);
        this.awri.set('banners', evt.banners).then(function (h) {
            _this.banners = h;
    ...
    SettingsPage.prototype.checkRole = function () {
    ...
    SettingsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
<<<<<<< HEAD
            selector: 'page-settings',template:/*ion-inline-start:"/home/robert/Projekte/RechZapp2/src/pages/settings/settings.html"*/'<ion-header>\n\n    <ion-navbar>\n        <ion-buttons end>\n            <button ion-button menuToggle>\n              <ion-icon name="menu"></ion-icon>\n            </button>\n            </ion-buttons>\n             \n            <ion-title>\n                Einstellungen\n              </ion-title>\n      <ion-buttons start>\n  <ng-template [ngIf]="this.awri.isInRole(\'authenticated user\')" [ngIfElse]="headerOut">\n              <button ion-button (click)="this.gotoLogin()">\n                  <img class="avatar" src="{{this.awri.user.picture}}"> {{awri.user?.name}}        \n                </button>\n  </ng-template>      \n  <ng-template #headerOut>\n              <button ion-button (click)="this.gotoLogin()">\n              <ion-icon name="contact"></ion-icon>  {{this.awri.user?.name}}\n              </button>\n  </ng-template>\n      </ion-buttons>    \n    </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n  <ion-item>\n    <ion-label>Verbunden mit: {{awri.HOST}}</ion-label>\n  </ion-item>\n  <ion-item>\n    <ion-label>Hilfe ein/aus</ion-label>\n    <ion-toggle [(ngModel)]="help" (ionChange)="this.helpChanged(this);" [disabled]="this.awri.isInRole(\'anonymous user\')"></ion-toggle>\n  </ion-item>\n  <ion-item>\n    <ion-label>Werbebanner ein/aus</ion-label>\n    <ion-toggle [(ngModel)]="banners" (ionChange)="this.bannersChanged(this);" [disabled]="this.awri.isInRole(\'sponsor\')"></ion-toggle>\n  </ion-item>\n<ion-item>\n    <ion-label item-start>Ihre Lesezeichen</ion-label>\n  <button ion-button (click)="this.gotoBookmarks()" item-end>Ansehen</button>\n</ion-item>\n<ng-template [ngIf]="this.awri.isInRole(\'administrator\')">\n<ion-item>\n    <ion-label item-start>Admin</ion-label>\n  <button ion-button (click)="this.gotoAdmin()" item-end>Ansehen</button>\n</ion-item>\n</ng-template>\n  <drupal7-login></drupal7-login>\n\n</ion-content>\n'/*ion-inline-end:"/home/robert/Projekte/RechZapp2/src/pages/settings/settings.html"*/,
=======
            selector: 'page-settings',template:/*ion-inline-start:"/mnt/PLATTE1/bionic/RechZapp2/src/pages/settings/settings.html"*/'<ion-header>\n\n    <ion-navbar>\n        <ion-buttons end>\n            <button ion-button menuToggle>\n              <ion-icon name="menu"></ion-icon>\n            </button>\n            </ion-buttons>\n             \n            <ion-title>\n                Einstellungen\n              </ion-title>\n      <ion-buttons start>\n  <ng-template [ngIf]="this.awri.isInRole(\'authenticated user\')" [ngIfElse]="headerOut">\n              <button ion-button (click)="this.gotoLogin()">\n                  <img class="avatar" src="{{this.awri.user.picture}}"> {{awri.user?.name}}        \n                </button>\n  </ng-template>      \n  <ng-template #headerOut>\n              <button ion-button (click)="this.gotoLogin()">\n              <ion-icon name="contact"></ion-icon>  {{this.awri.user?.name}}\n              </button>\n  </ng-template>\n      </ion-buttons>    \n    </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n  <ion-item>\n    <ion-label>Verbunden mit: {{awri.HOST}}</ion-label>\n  </ion-item>\n  <ion-item>\n    <ion-label>Hilfe ein/aus</ion-label>\n    <ion-toggle [(ngModel)]="help" (ionChange)="this.helpChanged(this);" [disabled]="this.awri.isInRole(\'anonymous user\')"></ion-toggle>\n  </ion-item>\n  <ion-item>\n    <ion-label>Werbebanner ein/aus</ion-label>\n    <ion-toggle [(ngModel)]="banners" (ionChange)="this.bannersChanged(this);" [disabled]="this.awri.isInRole(\'sponsor\')"></ion-toggle>\n  </ion-item>\n<ion-item>\n    <ion-label item-start>Ihre Lesezeichen</ion-label>\n  <button ion-button (click)="this.gotoBookmarks()" item-end>Ansehen</button>\n</ion-item>\n<ng-template [ngIf]="this.awri.isInRole(\'administrator\')">\n<ion-item>\n    <ion-label item-start>Admin</ion-label>\n  <button ion-button (click)="this.gotoAdmin()" item-end>Ansehen</button>\n</ion-item>\n</ng-template>\n  <drupal7-login></drupal7-login>\n\n</ion-content>\n'/*ion-inline-end:"/mnt/PLATTE1/bionic/RechZapp2/src/pages/settings/settings.html"*/,
>>>>>>> 7fcd870f640e073fe0c2944911b9e17daed1289f
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_auth_auth__["a" /* AuthProvider */]])
    ], SettingsPage);
...
var CommentComponent = /** @class */ (function () {
    ...
    CommentComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
<<<<<<< HEAD
            selector: 'comment',template:/*ion-inline-start:"/home/robert/Projekte/RechZapp2/src/components/comment/comment.html"*/'<!-- Generated template for the CommentComponent component -->\n<div>\n\n\n      <ion-title>{{text}}</ion-title>\n      <ion-label text-wrap color="danger">{{sent}}</ion-label>\n      <ion-item text-wrap>\n        <ion-textarea [(ngModel)]="comment"  name="comment" id="commentField" [disabled]="auth.isInRole(\'anonymous user\')"></ion-textarea>\n        </ion-item>      \n   \n    <button ion-button round full (click)="addcomment()"  [disabled]="auth.isInRole(\'anonymous user\')"> Antwort senden</button>\n \n</div>\n'/*ion-inline-end:"/home/robert/Projekte/RechZapp2/src/components/comment/comment.html"*/
=======
            selector: 'comment',template:/*ion-inline-start:"/mnt/PLATTE1/bionic/RechZapp2/src/components/comment/comment.html"*/'<!-- Generated template for the CommentComponent component -->\n<div>\n\n\n      <ion-title>{{text}}</ion-title>\n      <ion-label text-wrap color="danger">{{sent}}</ion-label>\n      <ion-item text-wrap>\n        <ion-textarea [(ngModel)]="comment"  name="comment" id="commentField" [disabled]="auth.isInRole(\'anonymous user\')"></ion-textarea>\n        </ion-item>      \n   \n    <button ion-button round full (click)="addcomment()"  [disabled]="auth.isInRole(\'anonymous user\')"> Antwort senden</button>\n \n</div>\n'/*ion-inline-end:"/mnt/PLATTE1/bionic/RechZapp2/src/components/comment/comment.html"*/
>>>>>>> 7fcd870f640e073fe0c2944911b9e17daed1289f
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_auth_auth__ = __webpack_require__(7);
...
var BookmarkComponent = /** @class */ (function () {
    ...
    BookmarkComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
<<<<<<< HEAD
            selector: 'bookmark',template:/*ion-inline-start:"/home/robert/Projekte/RechZapp2/src/components/bookmark/bookmark.html"*/'\n<ion-icon name="bookmark" (click)="setBookmark()" color="{{color}}" title="Lesezeichen setzten/entfernen"></ion-icon><ion-badge color="secondary">{{count}}</ion-badge>\n\n'/*ion-inline-end:"/home/robert/Projekte/RechZapp2/src/components/bookmark/bookmark.html"*/
=======
            selector: 'bookmark',template:/*ion-inline-start:"/mnt/PLATTE1/bionic/RechZapp2/src/components/bookmark/bookmark.html"*/'\n<ion-icon name="bookmark" (click)="setBookmark()" color="{{color}}" title="Lesezeichen setzten/entfernen"></ion-icon><ion-badge color="secondary">{{count}}</ion-badge>\n\n'/*ion-inline-end:"/mnt/PLATTE1/bionic/RechZapp2/src/components/bookmark/bookmark.html"*/
>>>>>>> 7fcd870f640e073fe0c2944911b9e17daed1289f
        }),
...
var ViewPage = /** @class */ (function () {
    function ViewPage(httpClient, actionSheetCtrl, navCtrl, navParams, awri) {
        ...
        this.awri.loadNode(this.nid).then(function (data) {
            _this.node = data;
            console.log(_this.node['statistics']);
            //console.log(data);
        });
    ...
    ViewPage.prototype.getComments = function (nid) {
        this.comments = this.httpClient.get(this.awri.HOST + '/' + this.awri.ENDPOINT + '/comment.json?parameters[nid]=' + nid + '&parameters[status]=1&pagesize=150')
            .map(function (res) { return res; });
    };
    ViewPage.prototype.getRating = function (nid) {
        var _this = this;
        this.awri.getRating(nid).then(function (data) {
            _this.rating = data;
            _this.bewertung = _this.rating.average.value;
        });
    };
    ViewPage.prototype.setRating = function (nid, val) {
        var _this = this;
        this.awri.setRating(nid, val).then(function (data) {
            _this.rating = data;
            _this.bewertung = _this.rating.average.value;
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_settings_settings__ = __webpack_require__(217);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_create_create__ = __webpack_require__(115);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_help_help__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_view_view__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_fragen_fragen__ = __webpack_require__(216);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_searchcat_searchcat__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__ionic_native_status_bar__ = __webpack_require__(213);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__ionic_native_splash_screen__ = __webpack_require__(214);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__angular_common_http__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__providers_auth_auth__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__components_drupal7_login_drupal7_login__ = __webpack_require__(297);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__ionic_native_admob_free__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__ionic_native_camera__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__components_upload_upload__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__ionic_storage__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__components_comment_comment__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__providers_stats_stats__ = __webpack_require__(298);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__components_bookmark_bookmark__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__components_bereich_bereich__ = __webpack_require__(299);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__components_banners_banners__ = __webpack_require__(300);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_22__components_drupal7_login_drupal7_login__["a" /* Drupal7LoginComponent */],
                __WEBPACK_IMPORTED_MODULE_25__components_upload_upload__["a" /* UploadComponent */],
                __WEBPACK_IMPORTED_MODULE_27__components_comment_comment__["a" /* CommentComponent */],
                __WEBPACK_IMPORTED_MODULE_29__components_bookmark_bookmark__["a" /* BookmarkComponent */],
                __WEBPACK_IMPORTED_MODULE_30__components_bereich_bereich__["a" /* BereichComponent */],
                __WEBPACK_IMPORTED_MODULE_31__components_banners_banners__["a" /* BannersComponent */],
                __WEBPACK_IMPORTED_MODULE_17__pages_searchcat_searchcat__["a" /* SearchcatPage */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["e" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_3__app_component__["a" /* MyApp */], {}, {
                    links: [
                        ...
                        { loadChildren: '../pages/searchcat/searchcat.module#SearchcatPageModule', name: 'SearchcatPage', segment: 'searchcat', priority: 'low', defaultHistory: [] },
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_23__ionic_native_admob_free__["a" /* AdMobFree */],
                __WEBPACK_IMPORTED_MODULE_25__components_upload_upload__["a" /* UploadComponent */],
                __WEBPACK_IMPORTED_MODULE_24__ionic_native_camera__["a" /* Camera */],
                __WEBPACK_IMPORTED_MODULE_27__components_comment_comment__["a" /* CommentComponent */],
                __WEBPACK_IMPORTED_MODULE_29__components_bookmark_bookmark__["a" /* BookmarkComponent */],
                __WEBPACK_IMPORTED_MODULE_28__providers_stats_stats__["a" /* StatsProvider */],
                __WEBPACK_IMPORTED_MODULE_31__components_banners_banners__["a" /* BannersComponent */]
            ]
        })
    ], AppModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_create_create__ = __webpack_require__(115);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_fragen_fragen__ = __webpack_require__(216);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
<<<<<<< HEAD
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/robert/Projekte/RechZapp2/src/app/app.html"*/'<ion-split-pane when="sm">\n\n    <ion-menu [content]="content" side="right">\n      <ion-header>\n        <ion-toolbar color="dark">\n          <ion-title>Menu</ion-title>\n        </ion-toolbar>\n      </ion-header>\n   \n      <ion-content class="menu-container">\n        <ion-list no-lines>\n          <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)" class="transparent list-item">\n            {{p.title}} \n\n          </button>\n        </ion-list>\n      </ion-content>\n   \n    </ion-menu>\n    <!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n    <ion-nav [root]="rootPage" #content main swipeBackEnabled="false"></ion-nav>\n    </ion-split-pane>'/*ion-inline-end:"/home/robert/Projekte/RechZapp2/src/app/app.html"*/
=======
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/mnt/PLATTE1/bionic/RechZapp2/src/app/app.html"*/'<ion-split-pane when="sm">\n\n    <ion-menu [content]="content" side="right">\n      <ion-header>\n        <ion-toolbar color="dark">\n          <ion-title>Menu</ion-title>\n        </ion-toolbar>\n      </ion-header>\n   \n      <ion-content class="menu-container">\n        <ion-list no-lines>\n          <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)" class="transparent list-item">\n            {{p.title}} \n\n          </button>\n        </ion-list>\n      </ion-content>\n   \n    </ion-menu>\n    <!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n    <ion-nav [root]="rootPage" #content main swipeBackEnabled="false"></ion-nav>\n    </ion-split-pane>'/*ion-inline-end:"/mnt/PLATTE1/bionic/RechZapp2/src/app/app.html"*/
>>>>>>> 7fcd870f640e073fe0c2944911b9e17daed1289f
        }),
...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
<<<<<<< HEAD
            selector: 'page-list',template:/*ion-inline-start:"/home/robert/Projekte/RechZapp2/src/pages/list/list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <banners></banners>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/home/robert/Projekte/RechZapp2/src/pages/list/list.html"*/
=======
            selector: 'page-list',template:/*ion-inline-start:"/mnt/PLATTE1/bionic/RechZapp2/src/pages/list/list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <banners></banners>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/mnt/PLATTE1/bionic/RechZapp2/src/pages/list/list.html"*/
>>>>>>> 7fcd870f640e073fe0c2944911b9e17daed1289f
        }),
...
var BereichComponent = /** @class */ (function () {
    ...
    BereichComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
<<<<<<< HEAD
            selector: 'bereich',template:/*ion-inline-start:"/home/robert/Projekte/RechZapp2/src/components/bereich/bereich.html"*/'\n  <ion-item>\n    <ion-label>Bereich</ion-label>\n\n    <ion-select [(ngModel)]="tid" name="bereich" (ionChange)="selectBereich($event)" disabled="{{!this.auth.isInRole(\'administrator\')}}">\n\n        <ion-option *ngFor="let item of bereiche" value="{{item.tid}}" id="{{item.tid}}">{{item.name}}</ion-option>\n\n    </ion-select>\n  </ion-item>    \n'/*ion-inline-end:"/home/robert/Projekte/RechZapp2/src/components/bereich/bereich.html"*/
=======
            selector: 'bereich',template:/*ion-inline-start:"/mnt/PLATTE1/bionic/RechZapp2/src/components/bereich/bereich.html"*/'\n  <ion-item>\n    <ion-label>Bereich</ion-label>\n\n    <ion-select [(ngModel)]="tid" name="bereich" (ionChange)="selectBereich($event)" disabled="{{!this.auth.isInRole(\'administrator\')}}">\n\n        <ion-option *ngFor="let item of bereiche" value="{{item.tid}}" id="{{item.tid}}">{{item.name}}</ion-option>\n\n    </ion-select>\n  </ion-item>    \n'/*ion-inline-end:"/mnt/PLATTE1/bionic/RechZapp2/src/components/bereich/bereich.html"*/
>>>>>>> 7fcd870f640e073fe0c2944911b9e17daed1289f
        }),
...
var BannersComponent = /** @class */ (function () {
    function BannersComponent(httpClient, awri) {
        //alert(this.name);
       ...
       */
        this.awri.get('banners').then(function (data) {
            _this.banners = (data != null) ? data : true;
            if (_this.banners == true)
                _this.getBanner('banner');
            //alert(this.banners);
            //  console.log(data);
        }).catch(function (err) {
            _this.banners = true;
    ...
    BannersComponent.prototype.getBanner = function (style) {
        var _this = this;
        this.httpClient.get('https://stage.awri.ch/banner/json/' + style).map(function (res) { return res; }).subscribe(function (data) {
            var dat = data;
            // console.log(data);
            _this.link = dat['link'];
            _this.image = dat['image'];
            //alert(this.image);
        });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", String)
    ], BannersComponent.prototype, "name", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", String)
    ], BannersComponent.prototype, "my", void 0);
    BannersComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
<<<<<<< HEAD
            selector: 'banners',template:/*ion-inline-start:"/home/robert/Projekte/RechZapp2/src/components/banners/banners.html"*/'<!-- Generated template for the BannersComponent component -->\n<!--\n<ion-input type="text" value="{{this.name}}"></ion-input>\n-->\n<ion-grid>\n    <ion-row justify-content-center align-items-center style="flex-direction: column">\n  <a href="{{link}}" target="_BLANK"><span innerHTML={{image}}></span></a>\n    </ion-row>\n </ion-grid>\n'/*ion-inline-end:"/home/robert/Projekte/RechZapp2/src/components/banners/banners.html"*/
=======
            selector: 'banners',template:/*ion-inline-start:"/mnt/PLATTE1/bionic/RechZapp2/src/components/banners/banners.html"*/'<!-- Generated template for the BannersComponent component -->\n<!--\n<ion-input type="text" value="{{this.name}}"></ion-input>\n-->\n<ion-grid>\n    <ion-row justify-content-center align-items-center style="flex-direction: column">\n  <a href="{{link}}" target="_BLANK"><span innerHTML={{image}}></span></a>\n    </ion-row>\n </ion-grid>\n'/*ion-inline-end:"/mnt/PLATTE1/bionic/RechZapp2/src/components/banners/banners.html"*/
>>>>>>> 7fcd870f640e073fe0c2944911b9e17daed1289f
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_2__providers_auth_auth__["a" /* AuthProvider */]])
    ], BannersComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(169);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthProvider = /** @class */ (function () {
    ...
    AuthProvider.prototype.getRating = function (nid) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.HOST + '/drupalgap/fivestar/' + nid + '.json?uid=' + _this.user.uid)
    ...
    AuthProvider.prototype.setRating = function (nid, val) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var headers = new __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["c" /* HttpHeaders */]()
                .set('X-CSRF-TOKEN', _this.token);
            ...
            _this.http.post(_this.HOST + '/' + _this.ENDPOINT + '/fivestar/rate', params, options).subscribe(function (data) {
                var arr = data;
                _this.getRating(nid);
                resolve(arr);
            }, function (err) {
    ...
    AuthProvider.prototype.search = function (text, page, limit) {
        var _this = this;
        if (page === void 0) { page = 0; }
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.http.get(_this.HOST + '/' + _this.ENDPOINT + '/search_node/retrieve.json?keys=' + text + '&page=' + page + '&pagesize=' + limit, options).subscribe(function (data) {
    ...
    AuthProvider.prototype.searchCat = function (text, tid, page) {
        var _this = this;
        if (tid === void 0) { tid = 93; }
        if (page === void 0) { page = 0; }
        return new Promise(function (resolve, reject) {
            //   this.showLoading("Suche, Bitte warten...");
            var headers = new __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["c" /* HttpHeaders */]()
            ...
            _this.http.get(_this.HOST + '/search/cat/json/' + tid + '?keys=' + text + '&page=' + page, options).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                //    this.hideLoading(); 
                reject(err);
